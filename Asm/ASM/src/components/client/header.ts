...
render(){
    ...
    <div class="bg-red-600 py-1 flex text-white">
        <div class="basis-3/12"><div class="float-right pr-40"><img class="" src="https://res.cloudinary.com/dtd8tra0o/image/upload/v1658160644/unnamed_cpppt8.png" width="65" height="56"></div></div>
        <div class="basis-4/12 static"><input class="w-full py-2 pl-6 my-3 rounded text-black"type="text"><img class="absolute w-6 pt-2" style="margin-top:-49px" src="https://res.cloudinary.com/dtd8tra0o/image/upload/v1654614957/search_lwjcp6.png"></div>
        ...
        <div class="basis-2/12">
             <div class="px-2 w-1/4 flex pl-10 mt-2"><a href="/signup">Đăng nhập</div>
        </div>
    </div>
